...
config{1}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{1}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{1}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
config{2}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{2}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{2}.bad.time_from_begin = 767; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
config{3}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{3}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{3}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
% config{4}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
% config{4}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
% config{4}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
% config{6}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
% config{6}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
% config{6}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
config{5}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{5}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{5}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
config{7}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{7}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{7}.bad.time_from_begin = 883; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
config{8}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{8}.bad.sample_list     = 1; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{8}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 9
...
config{9}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{9}.bad.sample_list     = 2; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{9}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 10
...
config{10}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{10}.bad.sample_list     = 1; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{10}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 11
...
config{11}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{11}.bad.sample_list     = 2; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{11}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 12
...
config{12}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{12}.bad.sample_list     = 1; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{12}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 13
...
config{13}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{13}.bad.sample_list     = 2; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{13}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 14
...
config{14}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{14}.bad.sample_list     = 2; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{14}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
config{15}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{15}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{15}.bad.time_from_begin = 1400; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 16
...
config{16}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{16}.bad.sample_list     = 1; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{16}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 17
...
config{17}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{17}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{17}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 18
...
config{18}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{18}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{18}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 19
...
config{19}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{19}.bad.sample_list     = 1; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{19}.bad.time_from_begin = 177; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 20
...
config{20}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{20}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{20}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 21
...
config{21}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{21}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{21}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 22
...
config{22}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{22}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{22}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 23
...
config{23}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{23}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{23}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 24
...
config{24}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{24}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{24}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 25
...
config{25}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{25}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{25}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 26
...
config{26}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{26}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{26}.bad.time_from_begin = 1021; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 27
...
config{27}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{27}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{27}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 28
...
config{28}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{28}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{28}.bad.time_from_begin = 1279; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 29
...
config{29}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{29}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{29}.bad.time_from_begin = 1052; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 30
...
config{30}.bad.markerStart     = 'CriseEnd'; %BAD � partir crise end
...
config{30}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{30}.bad.time_from_begin = 452; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
...
config{16}.bad.markerEnd       = 'end'; % BAD jusque fin du fichier
config{16}.bad.dir_list        = 'last'; %nouveau marqueur BAD sur dernier des 2 fichiers
config{16}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{16}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 17
config{17}                     = configcommon;
config{17}.datasavedir         = datasavedir;       %path where to save MuseStruct data
...
config{19}.bad.markerEnd       = 'end'; % BAD jusque fin du fichier
config{19}.bad.dir_list        = 'last'; %nouveau marqueur BAD sur dernier des 2 fichiers
config{19}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{19}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 20
config{20}                     = configcommon;
config{20}.datasavedir         = datasavedir;       %path where to save MuseStruct data
...
config{26}.bad.dir_list        = 'last'; %nouveau marqueur BAD sur dernier des 2 fichiers
config{26}.bad.sample_list     = 'last'; %dernier marqueur crise END pris en compte (en cas de multiple crise sur un m�me fichier)
config{26}.bad.time_from_begin = 1800; %d�but � +60s de crise END (pour rfaire spike sorting sur crise et post critique imm�diat)
%% patient 27
config{27}                     = configcommon;
config{27}.datasavedir         = datasavedir;       %path where to save MuseStruct data
