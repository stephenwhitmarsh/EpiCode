...
fname_output = fullfile(cfg.datasavedir,[cfg.prefix,'all_concatinated_trialinfo_allmarkers.mat']);
...
if exist(fname_output,'file') && cfg.force == false
    ...
    for ichan = 1 : size(cfg.channel,2)
        ...
        fname                       = fullfile(cfg.datasavedir,[cfg.prefix,'all_concatinated_',cfg.channel{ichan},'.ncs']);
