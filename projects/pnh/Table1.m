function t = Table1(cfg, MuseStruct)

fname_in = fullfile(cfg{1}.datasavedir, 'pattern_quantifications.xlsx');
dat = readtable(fname_in);
...
fname_out = fullfile(cfg{1}.imagesavedir, 'Table1.xls');
