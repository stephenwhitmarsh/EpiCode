...
%define epochs
%IED
configcommon.epoch.toi.IED          = [-0.5  1]; %entre -0.5s avant le marker et +1 apres le marker
configcommon.epoch.pad.IED          = 1;
...
% % markers used to anotate IDED on the different microelectrodes
% 
% config{1}.verifymarkers.one_off = 'Spike_mHaT2_1'; %{'Spike_mHaT2_1','Spike_mHaT2_2'}
% 
% %define IED epochs
% config{1}.muse.startmarker.IED    = 'Spike_mHaT2_1';
% config{1}.muse.endmarker.IED      = 'Spike_mHaT2_1';
% 
% %define interIED epochs
% config{1}.muse.startmarker.interIED     = {'Spike_mHaT2_1'}; %{'Spike_mHaT2_1', 'name_macro1', 'name_macro2'}
% config{1}.muse.endmarker.interIED       = {'Spike_mHaT2_1'}; %{'Spike_mHaT2_1', 'name_macro1', 'name_macro2'}
% 
% config{1}.LFP.channel                   = {'_mHaT2_1','_mHaT2_2', 'mHaT2_8', 'mHmT2_5', 'mHmT2_8'};
% config{1}.align.channel                 = {'_mHaT2_1','_mHaT2_2'};
% config{1}.alignpeak.channel.IED         = '_mHaT2_1';
% 
% config{1}.circus.channel                = {'mHaT2_1', 'mHaT2_2', 'mHaT2_8', 'mHmT2_5', 'mHmT2_8'};
% config{1}.circus.channelname            = {'mHaT2',   'mHaT2',   'mHaT2',   'mHmT2',   'mHmT2'};
% 
