...
%     trialinfo = dat.trialinfo;
    ...
    for ichan = 1 : size(dat.trial{1},1)
        ...
        %     ft_write_data(fullfile(cfg.datasavedir,[cfg.label,'_concatinated_data_',num2str(ichan),'.ncs']),dat.trial{1}(ichan,:),'chanindx',1,'dataformat','neuralynx_ncs','header',hdr);
