function [dat_unit, dat_lfp] = plotGrandAverageTimelockedModel(cfg, force)

set(groot,'defaultAxesTickLabelInterpreter','none');
hyplabels   = ["REM",  "AWAKE", "PHASE_1", "PHASE_2", "PHASE_3"];
fname_out   = fullfile(cfg{1}.datasavedir, 'AllDataCombinedTimelocked.mat');
...
% IED rate (determined by ISI) explains sleepstage
[B, dev, stats] = mnrfit([dat_lfp.ISI, dat_lfp.maxpeak, dat_lfp.maxpeak], dat_lfp.sleepstage, 'model', 'ordinal')
