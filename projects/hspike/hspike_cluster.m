...
[MuseStruct_aligned{ipatient}]          = alignMuseMarkersXcorr(config{ipatient}, MuseStruct_orig{ipatient}, true, '-original');
[~, LFP_cluster{ipatient}]              = clusterLFP(config{ipatient}, MuseStruct_aligned{ipatient}, true);
...
% 
% [MuseStruct_combined_aligned{ipatient}]                                                         = alignMuseMarkersXcorr(config{ipatient}, MuseStruct_combined{ipatient}, true, '-combined');
