...
configcommon.align.filter              = {'lp'};%bp pour retirer les variations trop lentes de signal qui empêchent de comparer la baseline et de chercher des maxima locaux
