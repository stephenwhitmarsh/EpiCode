#!/bin/bash
#SBATCH --job-name=plot_seizuresanesth
...
matlab -nodesktop -softwareopengl -nosplash -nodisplay -r "dtx_cluster_eegvideo_plotalldata($SLURM_ARRAY_TASK_ID,'dtx_eeganesth_setparams');"
sleep 5;
