...
for ipatient = 1
    ...
    for imarker = 1:length(config{1}.LFP.name) 
        dtx_plot_timecourse_eeg_emg(config{ipatient}, dat_macro{1}, iEEG, iEMG, imarker);
        dtx_plot_comparison_eeg_emg(config{ipatient}, dat_macro{1}, iEEG, iEMG, imarker); %add exception if no EMG
    end
