...
%for peak detection
configcommon.align.name                = {'SlowWave_R_peak','SlowWave_L_peak'};
...
configcommon.LFP.motorcortex           = {'C4','C3','C4','C3','C4','C3','C4','C3'};
...
configcommon.LFP.baselinewindow        = {[-2, -1], [-2, -1], [-2, -1], [-2, -1], [-2, -1], [-2, -1], [-2, -1], [-2, -1]};
...
configcommon.EMG.refchannel            = 'no';
...
config{1}.LFP.electrodetoplot       = {'F4','F3','F4','F3','F4','F3','F4','F3'};
...
config{2}.LFP.electrodetoplot       = {'C4','Fp1','C4','Fp1','C4','Fp1','C4','Fp1'};
...
config{3}.LFP.electrodetoplot       = {'C4','no','C4','no','C4','no','C4','no'};
...
config{4}.LFP.electrodetoplot       = {'F4','F3','F4','F3','F4','F3','F4','F3'};
...
config{5}.LFP.electrodetoplot       = {'F4','F3','F4','F3','F4','F3','F4','F3'};
