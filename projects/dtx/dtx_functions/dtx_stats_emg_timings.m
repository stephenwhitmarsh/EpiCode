...
%mandatory : 
% cfg.emgtimings.emg_start
% cfg.emgtimings.emg_end
% cfg.emgtimings.eeg_start
% cfg.emgtimings.winsize        
% cfg.emgtimings.winstep  
%optional :
% cfg.emgtimings.analysis_start
% cfg.emgtimings.analysis_end
% cfg.emgtimings.injection_clock
