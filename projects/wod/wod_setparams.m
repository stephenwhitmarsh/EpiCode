...
configcommon.LFP.wod_toisearch                  = [0 50]; %s, were to find wod negative peak relative to the muse marker
configcommon.LFP.wor_toisearch                  = [0 25]; %s, were to find wor positive peak relative to the muse marker

configcommon.timefreq.foi          = [1:1:100];%Hz
configcommon.timefreq.foi_band     = {[1 5],[5 10],[10 25],[25 50]};%Hz
