...
for ipatient = pat_list
    ...
    % Antoine concatenated data
    [~,dir_name]                       = fileparts(config{ipatient}.rawdir);
    config{ipatient}.rawdir                = fullfile(config{ipatient}.datasavedir,'concatenated_LFP');
    config{ipatient}.directorylist{ipart}  = {dir_name};
