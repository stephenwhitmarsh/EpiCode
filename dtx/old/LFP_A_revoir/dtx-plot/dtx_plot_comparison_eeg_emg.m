...
ylabel(sprintf('EEG %s (�V)',data_EEG.label{1}),'Fontsize',15,'Interpreter','none');
...
ylabel(sprintf('%s (�V)',data_EMG.label{1}),'Fontsize',15,'Interpreter','none');
set(gca,'FontWeight','bold' );
set(gca,'TickDir','out');
xlim([-abscisse_scale, abscisse_scale]);
set(gca,'ycolor','b');
...
yyaxis left
set(gca,'ycolor','r');
ylabel(sprintf('EEG %s (�V)',data_EEG.label{1}), 'Fontsize',15);
