...
%     
    ...
    for itemp = 1 : length(SpikeTrials{ipart}.label)
        plot(1:nr_stages,normalize(stats{ipart}.mean_freq{itemp}(1:end),'norm'),'.-','color',C(itemp,:));
    end
    ...
    for itemp = 1 : length(SpikeTrials{ipart}.label)
        plot(1:nr_stages,normalize(stats{ipart}.stdev_freq{itemp}(1:end),'norm'),'.-','color',C(itemp,:));
    end
    set(gca,'Xtick', 1 : nr_stages,'Xticklabels',{'-1','1','2','3','4','5'},'TickDir','out');
    ylabel('normalized');
    axis tight
    ...
    for itemp = 1 : length(SpikeTrials{ipart}.label)
        plot(1:nr_stages,normalize(stats{ipart}.mode_freq{itemp}(1:end),'norm'),'.-','color',C(itemp,:));
    end
    set(gca,'Xtick', 1 : nr_stages,'Xticklabels',{'-1','1','2','3','4','5'},'TickDir','out');
    ylabel('normalized');
    axis tight
    ...
    for itemp = 1 : length(SpikeTrials{ipart}.label)
        plot(1:nr_stages,normalize(stats{ipart}.CV_pooled{itemp}(1:end),'norm'),'.-','color',C(itemp,:));
    end
    set(gca,'Xtick', 1 : nr_stages,'Xticklabels',{'-1','1','2','3','4','5'},'TickDir','out');
    ylabel('normalized');
    axis tight
    ...
    for itemp = 1 : length(SpikeTrials{ipart}.label)
        plot(1:nr_stages,normalize(stats{ipart}.CV_trialavg{itemp}(1:end),'norm'),'.-','color',C(itemp,:));
    end
    set(gca,'Xtick', 1 : nr_stages,'Xticklabels',{'-1','1','2','3','4','5'},'TickDir','out');
    ylabel('normalized');
    axis tight
    ...
    for itemp = 1 : length(SpikeTrials{ipart}.label)
        plot(1:nr_stages,normalize(stats{ipart}.CV2_trialavg{itemp}(1:end),'norm'),'.-','color',C(itemp,:));
    end
    set(gca,'Xtick', 1 : nr_stages,'Xticklabels',{'-1','1','2','3','4','5'},'TickDir','out');
    ylabel('normalized');
    axis tight
    ...
    for itemp = 1 : length(SpikeTrials{ipart}.label)
        plot(1:nr_stages,normalize(stats{ipart}.burstindex{itemp}(1:end),'norm'),'.-','color',C(itemp,:));
    end
    set(gca,'Xtick', 1 : nr_stages,'Xticklabels',{'-1','1','2','3','4','5'},'TickDir','out');
    ylabel('normalized');
    axis tight
