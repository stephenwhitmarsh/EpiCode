...
%                 end
                ...
                if write
                    ...
                    cfgtemp                   = [];
                    cfgtemp.dataset           = fullfile(MuseStruct{ipart}{idir}.directory, MuseStruct{ipart}{idir}.filenames{ichan});
                    fprintf('LOADING: %s\n',cfgtemp.dataset);
                    clear fname
...
%                 end
        ...
        if write
            ...
            dlmwrite(fullfile(cfg.datasavedir,subjdir,partdir,filename),dirlist{ipart});
        end
