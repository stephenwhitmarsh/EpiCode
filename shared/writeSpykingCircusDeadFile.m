...
% WRITESPYKINGCIRCUSDEADFILE crawls and searches through data
% directories and markerfiles for artifact definitions for SpykingCircus.
%
% use as
%   writeSpykingCircusDeadFile(cfg, MuseStruct)
%
% The input structure can be read by readMuseMarkers.m, and edited before
% writing it to artefact files for SpikingCircus
%
% Mandatory inputs:
